    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Lek przeciwbólowy", "Ibuprofen", "Analgesic" },
                    { 2, "Lek przeciwgorączkowy", "Paracetamol", "Antipyretic" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1980, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Piotr", "Zieliński" },
                    { 2, new DateTime(1990, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Maria", "Wiśniewska" }
                });
